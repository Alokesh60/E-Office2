  ...
  return (
        ...
        <nav className={styles.nav}>
            <ul className={styles.nav__list}>
                <Link to="/" className={`${styles.nav__link} ${location.pathname === '/' ? styles.active_link : ''}`}>
                    <i className="ri-dashboard-3-line"></i>
                    <span className={styles.nav__name}>Home</span>
                </Link>

                <Link to="/account" className={`${styles.nav__link} ${location.pathname === '/account' ? styles.active_link : ''}`}>
                ...
                <Link to="/files" className={`${styles.nav__link} ${location.pathname === '/files' ? styles.active_link : ''}`}>
                    <i className="ri-file-list-3-line"></i>
                    <span className={styles.nav__name}>Files</span>
                </Link>

                <Link to="/settings" className={`${styles.nav__link} ${location.pathname === '/settings' ? styles.active_link : ''}`}>
